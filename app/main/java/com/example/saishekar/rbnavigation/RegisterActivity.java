...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    String Password = "[0-9]{10},[A-Z]{8},[a-z]{8}";
...
//            return;
//        }
//        if (!inputValidation.isInputEditTextEmail(textInputEditTextPhone, textInputLayoutPhone, getString(R.string.error_message_phone))) {
//            return;
//        }
        ...
        if (!databaseHelper.checkUser(textInputEditTextPhone.getText().toString().trim())) {
           ...
           login.setPhone(Integer.parseInt(textInputEditTextPhone.getText().toString().trim()));
            ...
            Snackbar.make(nestedScrollView, getString(R.string.error_phone_exists), Snackbar.LENGTH_LONG).show();
        }
...
import com.example.saishekar.rbnavigation.app.AppConfig;
import com.example.saishekar.rbnavigation.app.AppController;
import com.example.saishekar.rbnavigation.helper.SQLiteHandler;
import com.example.saishekar.rbnavigation.helper.SessionManager;
